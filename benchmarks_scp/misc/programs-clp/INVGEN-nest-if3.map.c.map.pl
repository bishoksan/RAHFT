...
new15(A,B,C,D,E,F) :- G=1+C, B=< -1, new9(A,G,D,E,F).
new15(A,B,C,D,E,F) :- G=1+C, B>=1, new9(A,G,D,E,F).
new11(A,B,C,D,E) :- F=1+C, G=1+E, A=< -1, new7(A,B,F,D,G).
new11(A,B,C,D,E) :- F=1+C, G=1+E, A>=1, new7(A,B,F,D,G).
new11(A,B,C,D,E) :- F=1+C, A=0, new7(A,B,F,D,E).
new10(A,B,C,D,E) :- F=1, B>=1, new15(A,F,B,C,D,E).
new10(A,B,C,D,E) :- F=0, B=<0, new15(A,F,B,C,D,E).
