...
new11(A,B,C,D,E,F,G,H) :- I= -1+E, J=1+G, A=< -1, new7(B,C,D,I,F,J,H).
new11(A,B,C,D,E,F,G,H) :- I= -1+E, J=1+G, A>=1, new7(B,C,D,I,F,J,H).
new9(A,B,C,D,E,F,G) :- H= -1+D, I=1+G, A-G>=1, new9(A,B,C,H,E,F,I).
new8(A,B,C,D,E,F,G) :- H=1, D>=1, new11(H,A,B,C,D,E,F,G).
new8(A,B,C,D,E,F,G) :- H=0, D=<0, new11(H,A,B,C,D,E,F,G).
