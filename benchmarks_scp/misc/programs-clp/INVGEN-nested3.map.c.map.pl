new14(A,B,C,D,E) :- A=0.
new14(A,B,C,D,E) :- F=1+B, A=< -1, new9(F,C,D,E).
new14(A,B,C,D,E) :- F=1+B, A>=1, new9(F,C,D,E).
new11(A,B,C,D) :- E=1+A, A-C=< -1, new11(E,B,C,D).
new11(A,B,C,D) :- E=1+B, A-C>=0, new7(A,E,C,D).
new10(A,B,C,D) :- E=1, A>=1, new14(E,A,B,C,D).
new10(A,B,C,D) :- E=0, A=<0, new14(E,A,B,C,D).
